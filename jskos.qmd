...
services         [set] of [service]         Services to access the content of the concept scheme
...
distributions [set] of [distributions]   [Distributions] to access the content of the registry
services      [set] of [service]         Services to access the content of the registry
...
services      [set] of [service]        Services to access the content of the concordance
