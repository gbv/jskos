...
Neither is mapping from JSKOS data to RDF a normative part of this specification.
:::
...
Conversion of JSKOS registries to RDF requires a different value for field
`concepts` to not infer the RDF property `skos:inScheme` but `dct:isPartOf`!
:::
