...
::: {.callout-note}
See appendix [object types classification](#object-type-classification) for an encoding of object types as concept scheme.
:::
...
----------------------------------------------------------- ------------------
<http://www.w3.org/2004/02/skos/core#Concept>               [concepts] (field `concepts`, `types`, and `properties`)
<http://www.w3.org/2004/02/skos/core#ConceptScheme>         [concept schemes] (field `schemes`)
<http://www.w3.org/2004/02/skos/core#mappingRelation>       [mappings] (field `mappings`)
<http://rdf-vocabulary.ddialliance.org/xkos#Correspondence> [concordances] (field `concordances`)
??? (not specified yet)                                     [occurrences] (field `occurrences`)
<http://www.w3.org/ns/dcat#Catalog>                         [registries] (field `registries`)
<http://www.w3.org/ns/oa#Annotation>                        [annotations] (field `annotations`)
...
```{.json #lst-concept1 lst-cap="A concept collection"}
