...
`endPlace`, `example`, `hiddenLabel`, `historyNote`, `identifier`, `issue`,
`issueTracker`,  `issued`, `location`, `modified`, `notation`, `note`,
`partOf`, `place`, `prefLabel`, `publisher`, `rank`, `scopeNote`, `source`,
`startDate`, `startPlace`, `subjectOf`, `subject`, `tool`, `type`, `uri`,
`url`, `version`, and `versionOf`):
...
`partOf`, `place`, `prefLabel`, `publisher`, `rank`, `scopeNote`, `source`,
`startDate`, `startPlace`, `subjectOf`, `subject`, `tool`, `type`, `uri`,
`url`, `version`, and `versionOf`). All fields except `fromScheme` and
...
`created`, `creator`, `definition`, `depiction`, `editorialNote`, `endDate`,
`endPlace`, `example`, `hiddenLabel`, `historyNote`, `identifier`, `issue`,
`issueTracker`, `issued`, `location`, `modified`, `notation`, `note`, `partOf`,
`place`, `prefLabel`, `publisher`, `rank`, `scopeNote`, `source`, `startDate`,
`startPlace`, `subjectOf`, `subject`, `tool`, `type`, `uri`, `url`, `version`,
and `versionOf`). All fields except `from` and `to` are optional.
...
- Add item fields `tool`, `version`, `issue`, and `issueTracker`
