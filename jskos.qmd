...
See @fig-types for the class hierarchy of JSKOS data elements and @fig-links for connections between main types.
...
In addition there are JSON objects based on other specifications. These are listed as [data types](#sec-data-types) in the previous section:
...
![hierarchy of JSKOS object types](types.svg){#fig-types}

![connections between main object types](links.svg){#fig-links}
...
A [registry] object can be used to combine arbitrary mappings without this constraint.
