...
In addition URIs <http://www.w3.org/ns/oa#Annotation> SHOULD be used to refer to [annotations] and URI <http://iiif.io/api/presentation/2#Manifest> SHOULD be used to refer to [media] objects, if needed.

An **object type URI** is an item type URI, or the URI <http://www.w3.org/ns/oa#Annotation>, or an URI for [occurrences] (not specified yet).
...
Field `objectTypes`, if given, SHOULD include the URI <http://www.w3.org/2004/02/skos/core#ConceptScheme>.
...
context. The context is typically a database with entities having some relation
to the concepts.

For instance the occurrence could give the number of documents indexed with some term in a catalog. The field `url`
