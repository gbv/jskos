...
The first element of array field `type`, if given, MUST be the [item type] URI
<http://purl.org/cld/cdtype/CatalogueOrIndex>. Applications SHOULD also accept
alternative URI <http://www.w3.org/ns/dcat#Catalog> because the item type URI
for registries is going to be changed to this value a future version of JSKOS
specification.
