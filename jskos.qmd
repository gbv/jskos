...
- [JSKOS Mappings](#mapping) in RDF can be expressed as plain triples, as
  reified triples, as objects of their own right, or with [RDF-star]. The most
...
See NodeJS library [jskos-validate] for an implementation with additional rules not covered by JSON Schema alone.
